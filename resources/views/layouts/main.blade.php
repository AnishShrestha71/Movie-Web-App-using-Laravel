...
<body class="font-sans bg-gray-900 text-white mx-12">
        ...
        <div class="container  mx-auto flex flex-col md:flex-row items-center justify-between px-4 py-6">
            ...
            <ul>
                <div class="flex items-center">
                    ...
                    {{-- <div class="ml-4">
                        <img src="https://i.pinimg.com/736x/4a/ec/be/4aecbea509e1d55bab992063ae8de65d.jpg" alt="" class="rounded-full w-8 h-8">
                    </div> --}}
                </div>
            </ul>
        </div>
    ...
    @livewireScripts
    @yield('scripts')
    <footer class="mt-12 h-4 mb-8">
        <div class="text-right text-lg"> &copy; 2021 Powered By: Anish Shrestha</div>
    </footer>
</body>
