<div class="relative mt-3 md:mt-0" x-data="{ isOpen: true }" @click.away="isOpen = false" @click="isOpen = true">
    <input wire:model.debounce.500="search" type="text"
    ...
    @if (strlen($search) > 2)
        ...
        <div class="z-50 absolute bg-gray-800 text-sm rounded w-64" x-show.transition.opacity="isOpen"
