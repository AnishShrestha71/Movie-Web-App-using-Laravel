...
@section('content')
    <div class="movie-info border-b border-gray-800">
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            <img src="{{ 'https://image.tmdb.org/t/p/w500/' . $tv['poster_path'] }}" alt="" class="w-64 lg:w-96">
            <div class="md:ml-24">
                <h2 class="text-4xl font-semibold mt-2 md:mt-0">{{ $tv['name'] }}</h2>
                <div class="flex flex-wrap items-center text-gray-400 text-sm">
                    ...
                    <span class="ml-2">{{ $tv['vote_average'] }}</span>
                    <span class="mx-2">|</span>
                    <span class="mx-2">{{ $tv['first_air_date'] }}</span>
                    <span class="mx-2">|</span>
                    <span>
                       {{$tv['genres']}}
                    </span>
    ...
    <div class="tv-cast border-b border-gray-600">
