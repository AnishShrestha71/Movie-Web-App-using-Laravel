...
@section('content')
    <div class="movie-info border-b border-gray-800">
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            <div class="flex-none">
                <img src=" {{ $actor['profile_path'] }} " alt="" class="w-64 lg:w-96">
                <ul class="flex items-center mt-4">
                    @if ($social['facebook'])
                        <li class="mr-4">
                            <a href="{{ $social['facebook'] }}" title="facebook"><svg
                                    class="fill-current text-gray-400 hover:text-white w-6" viewBox="0 0 448 512">
                                    <path
                    ...
                    @endif
                    @if ($social['instagram'])
                        <li class="mr-4"><a href="{{ $social['instagram'] }}" title="facebook"> <svg
                                    class="fill-current text-gray-400 hover:text-white w-6" viewBox="0 0 448 512">
                                    <path
                    ...
                    @endif
                    @if ($social['twitter'])
                        <li class="mr-4"><a href="{{ $social['twitter'] }}" title="facebook"> <svg
                                    class="fill-current text-gray-400 hover:text-white w-6" viewBox="0 0 512 512">
                                    <path
                    ...
                    @if ($actor['homepage'])
                        <li class="mr-4">
                            <a href="{{ $actor['homepage'] }}" title="Home Page"><svg
                                    class="fill-current text-gray-400 hover:text-white w-6" viewBox="0 0 496 512">
                                    <path
            ...
            <div class="md:ml-24">
                <h2 class="text-4xl font-semibold mt-2 md:mt-0">{{ $actor['name'] }}</h2>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5">
                    @foreach ($knownforTitles as $titles)
                        <div class="mt-4 mr-4">
                            <a href="{{ $titles['linkToPage'] }}">
                                <img src="{{ $titles['poster_path'] }}" alt="">
    ...
    <div class="credits border-b border-gray-600">
